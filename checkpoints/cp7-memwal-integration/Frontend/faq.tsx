...
const FAQS = [
  ...
  },
  {
    ...
    a: 'Sim! Aegis suporta MemWal como add-on. Use AegisDeepBookExecutor com memwalConfig para: (1) armazenar rationale privado no MemWal, (2) registrar métricas públicas no Aegis, (3) linkar blob_id do MemWal ao ReputationObject para trail de auditoria completo.'
  },
];
