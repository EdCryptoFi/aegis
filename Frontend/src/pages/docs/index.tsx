      ...
      <main className="docs-content">
        ...
        <section className="key-concepts">
          ...
          <ul>
            ...
            <li><Link href="/badges"><strong>Badges</strong></Link> - Bronze, Silver, and Gold certifications based on execution history</li>
            <li><strong>MemWal Audit Trail</strong> - <a href="https://docs.memwal.ai/" target="_blank" rel="noopener">Encrypted memory</a> for agent decision logs and verification</li>
          </ul>
        </section>
        ...
        <section className="memwal-section">
          ...
          <pre>{`// Using Aegis with MemWal Integration
...
// blob_id links to MemWal for full audit trail
`}</pre>
          <p className="note">
            <strong>Core Validation:</strong> Aegis validates reputation on-chain (execution counts, badges).
            MemWal provides the why (decision rationale) - fully auditable, fully private.
          </p>
        </section>
